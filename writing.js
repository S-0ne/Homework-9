...
function enterPersonalInfo() {
    const userInputName = prompt("Введіть своє прізвище та ім'я через пробіл: ");
    const userInputEmail = prompt("Введіть свою електронну пошту: ");
    const userInputNumber = prompt("Введіть свій номер, типу (+380956471834): ");
    const userInputBirth = prompt("Введіть свій день народження через пробіл(день, місяць, рік): ");
